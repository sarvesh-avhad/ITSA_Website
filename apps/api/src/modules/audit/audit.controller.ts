  ...
  async exportAuditLogs(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const flatData = logs.map(log => ({
        ...
        'Target Name': log.targetUserName || '',
        'Target Email': log.targetUserEmail || '',
      ...
      const columns = [
        ...
        { header: 'Resource ID', key: 'Resource ID', width: 25 },
        { header: 'Actor Name', key: 'Actor Name', width: 20 },
        { header: 'Actor Email', key: 'Actor Email', width: 25 },
        { header: 'Target Name', key: 'Target Name', width: 20 },
        { header: 'Target Email', key: 'Target Email', width: 25 },
        { header: 'Old Value', key: 'Old Value', width: 40 },
        { header: 'New Value', key: 'New Value', width: 40 },
        { header: 'IP Address', key: 'IP Address', width: 20 },
      ];
